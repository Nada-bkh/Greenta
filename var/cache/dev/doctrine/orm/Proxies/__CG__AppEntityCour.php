...
class Cour extends \App\Entity\Cour implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'niveau', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'categorie', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'quizzes', '' . "\0" . 'App\\Entity\\Cour' . "\0" . 'pdfpath'];
        }
     ...
     * {@inheritDoc}
     */
    public function addQuiz(\App\Entity\Quiz $quiz): static
    {
     ...
     * {@inheritDoc}
     */
    public function removeQuiz(\App\Entity\Quiz $quiz): static
    {
