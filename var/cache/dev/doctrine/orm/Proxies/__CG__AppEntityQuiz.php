...
class Quiz extends \App\Entity\Quiz implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'duree', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'note', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'nbrq', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'courid', '' . "\0" . 'App\\Entity\\Quiz' . "\0" . 'questions'];
        }
    ...
    public function getNbrq(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbrq', []);

        return parent::getNbrq();
    }
    ...
    public function setNbrq(int $nbrq): static
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrq', [$nbrq]);

        return parent::setNbrq($nbrq);
    }

    /**
     * {@inheritDoc}
     */
    public function getCourid(): ?\App\Entity\Cour
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCourid', []);

        return parent::getCourid();
    }

    /**
     * {@inheritDoc}
     */
    public function setCourid(?\App\Entity\Cour $courid): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCourid', [$courid]);

        return parent::setCourid($courid);
    }
     ...
     * {@inheritDoc}
     */
    public function addQuestion(\App\Entity\Question $question): static
    {
     ...
     * {@inheritDoc}
     */
    public function removeQuestion(\App\Entity\Question $question): static
    {
